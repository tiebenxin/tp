 ...
 */
package com.vipbcw.netroid.stack;
...
import com.vipbcw.netroid.Request.Method;
import com.vipbcw.netroid.toolbox.AndroidHttpClient;
    ...
    private static HttpUriRequest createHttpRequest(Request<?> request) throws AuthFailureError {
        switch (request.getMethod()) {
            case Method.GET:
                ...
                if (!TextUtils.isEmpty(request.hostName)) {
                    getRequest.setHeader("Host", request.hostName);
                }
                return getRequest;
            case Method.DELETE:
            ...
            case Method.POST: {
                ...
                postRequest.setHeader("Range", "bytes=");
                if (!TextUtils.isEmpty(request.hostName)) {
                    postRequest.setHeader("Host", request.hostName);
                }
//                postRequest.addHeader(HEADER_CONTENT_TYPE, request.getBodyContentType());
                if (request.postEntity != null) {
                    postRequest.setEntity(request.postEntity);
                }else {
            ...
            case Method.PUT: {
                ...
                if (!TextUtils.isEmpty(request.hostName)) {
                    putRequest.setHeader("Host", request.hostName);
                }
            ...
            case Method.PATCH: {
                ...
                if (!TextUtils.isEmpty(request.hostName)) {
                    patchRequest.setHeader("Host", request.hostName);
                }
