...
//        Log.d("getInstance",String.format("%s:%s",(mInstance==null?"null":mInstance.toString()),Log.getStackTraceString(new Throwable())));
        if (mInstance == null) {
...
//    public static BasePostRequest postTest(String url, String action, IHPAccountEnvironment environment) {
//        return new BasePostRequest(url, action, environment);
//    }
...
//
//    /** delete请求 */
//    public static DeleteRequest deleteMaxSize(String url) {
...
//    }
     ...
     */
    public OkHttpUtils debug(String tag, Level level, boolean isPrintException) {
    ...
    public OkHttpUtils setCertificates(InputStream... certificates) {
        ...
        okHttpClientBuilder.sslSocketFactory(sslParams.sSLSocketFactory);
        return this;
    }
