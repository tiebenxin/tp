...
public class FragmentRecyclerSecond extends FragmentBase {
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        return inflater.inflate(R.layout.fragment_recycler_second, container, false);
    }
    ...
    private void initView() {
        ...
        GridLayoutManager layoutManager = new GridLayoutManager(ContextHelper.getApplicationContext(), 2);
        DividerItemDecoration decoration = new DividerItemDecoration(ContextHelper.getApplicationContext(), R.drawable.divider, R.color.transparent);
